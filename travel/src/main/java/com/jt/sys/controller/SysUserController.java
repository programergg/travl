...
public class SysUserController {
	...
	public JsonResult doLogin(String username,
			String password,HttpSession session) throws UnsupportedEncodingException{
		
		System.out.println("进入后端登录系统");
		//1.封装用户信息(存储到一个令牌对象)
		...
		session.setAttribute("wuliuid", sysUserService.doSelectWuliuId(username));
