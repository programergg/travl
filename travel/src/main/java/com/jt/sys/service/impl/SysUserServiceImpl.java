...
public class SysUserServiceImpl implements SysUserService {
	...
	@Override
	public String doSelectWuliuId(String username) {
		
		return sysUserDao.doSelectWuliuId(username);
	}
	...
	public PageObject<SysUser> findPageObjects(
		...
		System.out.println(rowCount+"总记录数");
		if (rowCount == 0)
		...
		System.out.println(records.size()+"用户个数");
		// 5.封装数据
